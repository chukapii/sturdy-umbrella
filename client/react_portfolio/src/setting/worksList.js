...
import cryptodash from '../img/cryptodash.png';
...
const worksList = [
  ...
  },
  {
    ...
    stack: ['React','Websocket API','Charts.js'],
    //  gitHub: 'https://github.com/marieooq/react-msgif',
    description:
      'A Cryptocurrency dashboard using ReactJS and the free Coinbase API.',
    //url: '/works/cryptodash',
    project: 'personal',
    featured: true,
  },
  // {
